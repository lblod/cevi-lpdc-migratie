...
export class Procedure {
    ...
    toTriples(abbInstanceId: Uri, index: number, languageVersion: Language): (Triple | undefined)[] {
        ...
        return [
            ...
            Triple.createIfDefined(procedureId, Predicates.description, Literal.createIfDefined(this.description, languageVersion)),
            ...
            ((aWebsite, index) => aWebsite.toTriples(procedureId, Predicates.hasWebsite, index, languageVersion))
        ));
    }
}